...
ALL_SYNONYMS: Dict[str, List[str]] = {
    ...
    "Step": [
        'step', 'चरण', 'ধাপ', 'படி', 'అడుగు', 'પગલું', 'ਕਦਮ', 'ಹಂತ', 'ഘട്ടം', 'ଧାପ', 'පියවර',
        'قدم', 'گام', 'ګام', 'шаг', 'paso', 'pas', '段階', '步长', '단계', 'Schritt', 'passo',
        'langkah', 'βήμα', 'צעד', 'خطوة', 'krok', 'adım', 'adim', 'hatua', 'bước', 'stap',
        'ขั้น', 'lépés', 'lepes', 'askel', 'steg', 'hakbang', 'trin', 'քայլ', 'ნაბიჯი',
        'igbesẹ', 'mataki', 'ជំហាន', 'အဆင့်', 'ደረጃ', 'གོམ་པ', 'ᎠᏍᎦᏂ', 'ຂັ້ນ', 'ᠠᠯᠬᠤᠮ',
    ],
    "Struct": [
