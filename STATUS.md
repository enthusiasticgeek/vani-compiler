...
**Last updated:** 2026-06-01 (closures #577-#581 — f64 trig deg variants. **`f64_asin_deg(x)`**, **`f64_acos_deg(x)`** take dimensionless x in [-1,1], return degrees in [-90,90] / [0,180] respectively (multiply radian result by 180/π = 0x404CA5DC1A63C1F8). **`f64_sec_deg(d)`**, **`f64_csc_deg(d)`**, **`f64_cot_deg(d)`** take degrees, multiply by π/180 = 0x3F91DF46A2529D39 to convert to radians, then compute 1/cos / 1/sin / cos/sin. Both backends byte-identical: `asin_deg(1)=90`, `acos_deg(0)=90`, `sec_deg(60)=2`, `csc_deg(30)=2`, `cot_deg(45)=1`. 1 new lib test. 1536 lib + 54 parity green.)
