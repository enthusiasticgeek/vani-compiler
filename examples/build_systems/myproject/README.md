...
documents: a multi-file vāṇī program (`src/main.vani` imports
...
pipeline (vāṇī → C, compile, strip vāṇī's own `main`, compile the C
...
**The `main`-collision step, explained**: every vāṇī entry point
...
comment and the tutorial's "Calling vāṇī functions from C" section
