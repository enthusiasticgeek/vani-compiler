# Intermediate 12 â€” SMT verification deep-dive
...
> **New to this?** Read [Intermediate 12a â€” SMT primer](12a_smt_primer.md) and
> [Intermediate 12b â€” Compile time vs runtime primer](12b_compile_time_vs_runtime_primer.md) first.
...
mathematically discharged â€” not just tested, *proven*.

## The program

```vani
intent "Intermediate 12 worked example â€” SMT contracts in depth.";
...
The interesting part isn't the runtime output â€” it's the
...
software needs â€” just made explicit.
...
| Comparisons (`<`, `<=`, `==`, â€¦) | String predicates |
...
Beginner Â§9 covered the case where a `prove y == double(7)`
...
A "proof failed" diagnostic includes the **counterexample** â€”
...
**Congratulations â€” you've completed the Intermediate track!**

Next steps:

- **[Advanced track](../advanced/01_async.md)** â€” async / await,
