...
3. Lays out the **v1-specific deviation** (often a workaround
   for a documented [v1 limitation](https://github.com/anthropics/claude-code/blob/main/docs/v1_limitations.md)).
...
**Next**: [§12 — SMT verification deep-dive →](12_smt_deepdive.md)
