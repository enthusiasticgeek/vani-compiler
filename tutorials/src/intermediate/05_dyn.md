...
If none of those apply, the static-dispatch generic in [§4](04_generics_iface.md)
...
- **`Vec<dyn Iface>` as a struct field across multiple Iface
  types** was a bug ([L8 in v1_limitations.md](https://github.com/anthropics/claude-code/blob/main/docs/v1_limitations.md))
...
**Next**: [§6 — Closures and iterator combinators →](06_closures.md)
