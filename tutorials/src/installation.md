...
Verified: all **3,335 compiler tests** (3,007 lib tests + 328 integration/e2e tests) pass on Windows 11 with this setup.
...
vāṇī ships a Language Server implementing the **Language Server
