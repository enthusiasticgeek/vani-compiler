...
- Writing a new dialect (§9). The pipeline above is your
  roadmap.
...
The repo's [`README.md`](https://github.com/anthropics/claude-code/blob/main/README.md)
has the running language reference;
[`STATUS.md`](https://github.com/anthropics/claude-code/blob/main/STATUS.md)
