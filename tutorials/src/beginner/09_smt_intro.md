...
documented in
[`docs/v1_limitations.md` (L12)](https://github.com/anthropics/claude-code/blob/main/docs/v1_limitations.md).
...
`ensures` is covered in depth in **Intermediate §12 — SMT
...
**Next**: [§10 — Modules and `pub` →](10_modules.md)
