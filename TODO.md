...
- [ARC8_V3_PLAN.md](ARC8_V3_PLAN.md) — phased execution plan
  ...
  2.3d + 2.5 + 2.5b + 3a + 3b + 3c ✅ COMPLETE 2026-06-04** —
  ...
  with-unit-variant). Shipped via commits `eac1bf6`,
  `51748d6`, `7d47ff6`, `a3cab5b`, `7566ab8`, `b1b8113`,
  `22fc622`, `d3a0af3`, `a77b799`, `4702cb6`, `7a19b68`,
  `eb2a8af`, `cc8c8de`, `9fb16dc`, `754c163`, `defde20`,
  plus pending 3c. Phase 3d (Struct / Vec / Array locals)
  + 3e (payloaded enums) queued. Phase 2.4 (try) needs
  broader Phase 3 for non-i64 returns. **Next session
  recommended: Phase 3d (Struct/Vec/Array, ~10-15h)** or
  Phase 5 (macOS kqueue port, ~10-15h).
