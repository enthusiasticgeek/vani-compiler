...
- [ARC8_V3_PLAN.md](ARC8_V3_PLAN.md) — phased execution plan
  ...
  2.1a + 2.1b + 2.1c + 2.2 + 2.3-narrow + 2.3a + 2.3b + 2.5 +
  ...
  Wildcard) + loops with suspend in body + break/continue
  inside loops. Shipped via commits `eac1bf6`, `51748d6`,
  `7d47ff6`, `a3cab5b`, `7566ab8`, `b1b8113`, `22fc622`,
  `d3a0af3`, `a77b799`, `4702cb6`, `7a19b68`, plus
  pending 2.3b. Phase 2.3c (Variant patterns), 2.4 (try),
  3-4 queued. **Next session recommended: Phase 5
  (macOS kqueue port, ~10-15h)** or Phase 2.4 try
  keyword (~6-8h) or Phase 2.3c Variant patterns (~6-10h).
