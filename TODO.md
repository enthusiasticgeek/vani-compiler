...
- [ARC8_V3_PLAN.md](ARC8_V3_PLAN.md) — phased execution plan
  ...
  `d3a0af3`, `a77b799`, `4702cb6`. Phase 2.3 (match), 2.4
  (try), 3-4 queued. **Next session recommended: Phase 5
  (macOS kqueue port, ~10-15h)** or Phase 2.3 match arms
  (~8-10h) or Phase 2.4 try keyword (~6-8h).
