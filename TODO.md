...
- [ARC8_V3_PLAN.md](ARC8_V3_PLAN.md) — phased execution plan
  ...
  platform port (2 phases). **Phase 0 ✅ COMPLETE +
  Phase 1 ✅ COMPLETE 2026-06-04** — headline
  compiler-driven `async fn → Task` transform shipped via
  commits `eac1bf6`, `51748d6`, `7d47ff6`. Phases 2-4
  (control flow / affine / advanced async features) queued.
  **Next session recommended: Phase 5 (macOS kqueue port,
  ~10-15h)** — parallel-safe with v3.1, broadens platform
  base. Alternative: Phase 2 (control flow inside async
  bodies, ~15-20h).
