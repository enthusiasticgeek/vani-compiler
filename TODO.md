...
- [ARC8_V3_PLAN.md](ARC8_V3_PLAN.md) — phased execution plan
  ...
  2.3d + 2.5 + 2.5b + 3a + 3b + 3c + 3d + 3e + 3f ✅ COMPLETE
  ...
  / Array). Shipped via commits `eac1bf6`, `51748d6`,
  `7d47ff6`, `a3cab5b`, `7566ab8`, `b1b8113`, `22fc622`,
  `d3a0af3`, `a77b799`, `4702cb6`, `7a19b68`, `eb2a8af`,
  `cc8c8de`, `9fb16dc`, `754c163`, `defde20`, `af1d274`,
  `40c4047`, `64c93b0`, plus pending 3f. **v3.1 affine-
  locals: ALL major composite types shippable.** Phase 2.4
  (try) needs Phase 3-returns slice. **Next session
  recommended: Phase 5 (macOS kqueue port, ~10-15h)** or
  Phase 2.4 try (~6-8h once Phase 3-returns lands).
