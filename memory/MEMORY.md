...
- **External plan-of-record docs at `~/vani/`** (refreshed 2026-06-04):
  - `~/vani/ARC8_V3_PLAN.md` — **phased execution plan** for Arc 8 v3.1 compiler-driven sugar (5 phases, ~78-98h) + Arc 8 platform port (2 phases, ~35-50h). **Phase 0 ✅ COMPLETE 2026-06-04** (sleep_ms_async timerfd + host_is_linux gate; A0.2 deferred to Phase 1). Next session: Phase 1 linear core (~12-15h).
